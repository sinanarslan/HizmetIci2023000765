...
namespace MebFinalApp.Data.Concrete.Entityframework.context
{
    public class NorthwindDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-V1E2DEK\\SQLEXPRESS;Initial Catalog=Northwind;trusted_connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Personeller>(entity =>
            {
                ...
                entity.Property(e => e.BenimKolonum).HasMaxLength(50);
